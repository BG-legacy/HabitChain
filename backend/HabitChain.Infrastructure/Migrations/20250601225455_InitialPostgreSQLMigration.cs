        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StreakDay = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Encouragements_Habits_HabitId",
                        column: x => x.HabitId,
                        principalTable: "Habits",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserBadges_Habits_HabitId",
                        column: x => x.HabitId,
                        principalTable: "Habits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckIns_UserId_HabitId_CompletedAt",
                table: "CheckIns",
                columns: new[] { "UserId", "HabitId", "CompletedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Encouragements_FromUserId",
                table: "Encouragements",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Encouragements_HabitId",
                table: "Encouragements",
                column: "HabitId");

            migrationBuilder.CreateIndex(
                name: "IX_Encouragements_ToUserId_IsRead",
                table: "Encouragements",
